...
#sad
    ...
    def test200_020_ShouldRaiseExceptionInvalidBurnDown(self):
        iteration1 = Iteration.Iteration(30, 1)
        iteration2 = Iteration.Iteration(60, 3)
        myProject = Project.Project()
        myProject.add(iteration1)
    ...
    def test200_021_ShouldRaiseExceptionInvalidBurnDown(self):
        iteration1 = Iteration.Iteration(30, 1)
        iteration2 = Iteration.Iteration(60, 3)
        myProject = Project.Project()
        myProject.add(iteration1)
    ...
    def test200_040_ShouldRaiseExceptionInvalidProject(self):
        myCal = Calendar.Calendar()
        myCal.add(1, 10)
        myCal.add(2, 0)
        myCal.add(3, 30)
        ...
        expectedString = "Schedule.__init__:  "
        try:
            mySched = Schedule.Schedule(1,myCal)                                      
            self.fail("exception was not raised")                    
        except ValueError as raisedException:                                           
            diagnosticString = raisedException.args[0]                                   
            self.assertEquals(expectedString, diagnosticString[0:len(expectedString)]) 
    ...
    def test200_041_ShouldRaiseExceptionInvalidProject(self):
        myCal = Calendar.Calendar()
        myCal.add(1, 10)
        myCal.add(2, 0)
        myCal.add(3, 30)
        ...
        expectedString = "Schedule.__init__:  "
        try:
            mySched = Schedule.Schedule("X",myCal)                                      
            self.fail("exception was not raised")                    
        except ValueError as raisedException:                                           
            diagnosticString = raisedException.args[0]                                   
            self.assertEquals(expectedString, diagnosticString[0:len(expectedString)]) 
    ...
    def test200_050_ShouldRaiseExceptionInvalidCalendar(self):
        iteration1 = Iteration.Iteration(30, 1)
        iteration2 = Iteration.Iteration(60, 3)
        myProject = Project.Project()
        myProject.add(iteration1)
